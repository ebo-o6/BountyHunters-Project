(()=>{var e={};e.id=629,e.ids=[629],e.modules={2261:(e,t,r)=>{var i={"./v1.10.100/build/pdf.js":4417,"./v1.10.88/build/pdf.js":2350,"./v1.9.426/build/pdf.js":7344,"./v2.0.550/build/pdf.js":5630};function a(e){return r(n(e))}function n(e){if(!r.o(i,e)){var t=Error("Cannot find module '"+e+"'");throw t.code="MODULE_NOT_FOUND",t}return i[e]}a.keys=function(){return Object.keys(i)},a.resolve=n,e.exports=a,a.id=2261},399:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},7147:e=>{"use strict";e.exports=require("fs")},3685:e=>{"use strict";e.exports=require("http")},5687:e=>{"use strict";e.exports=require("https")},7310:e=>{"use strict";e.exports=require("url")},9796:e=>{"use strict";e.exports=require("zlib")},871:(e,t,r)=>{"use strict";r.r(t),r.d(t,{originalPathname:()=>y,patchFetch:()=>b,requestAsyncStorage:()=>h,routeModule:()=>m,serverHooks:()=>f,staticGenerationAsyncStorage:()=>g});var i={};r.r(i),r.d(i,{POST:()=>u});var a=r(9303),n=r(8716),s=r(3131),o=r(7070),l=r(3357),c=r.n(l),d=r(6945),p=r(2223);async function u(e){try{let t=(await e.formData()).get("cv");if(!t)return o.NextResponse.json({error:"No file uploaded"},{status:400});let r=Buffer.from(await t.arrayBuffer()),i=(await c()(r)).text;if(!i||i.trim().length<50)return o.NextResponse.json({error:"Could not extract text from PDF"},{status:400});let a=(0,p.sK)(i),n=await (0,d.AW)(a);return o.NextResponse.json({cv:n,rawText:i})}catch(e){return console.error("CV parsing error:",e),o.NextResponse.json({error:"Failed to parse CV"},{status:500})}}let m=new a.AppRouteRouteModule({definition:{kind:n.x.APP_ROUTE,page:"/api/parse-cv/route",pathname:"/api/parse-cv",filename:"route",bundlePath:"app/api/parse-cv/route"},resolvedPagePath:"/home/ebo_o6/Documents/GitHub/career-interpreter/app/api/parse-cv/route.ts",nextConfigOutput:"standalone",userland:i}),{requestAsyncStorage:h,staticGenerationAsyncStorage:g,serverHooks:f}=m,y="/api/parse-cv/route";function b(){return(0,s.patchFetch)({serverHooks:f,staticGenerationAsyncStorage:g})}},6945:(e,t,r)=>{"use strict";r.d(t,{AW:()=>o,OC:()=>s});let i=new(r(1258)).$D(process.env.GEMINI_API_KEY),a=i.getGenerativeModel({model:"gemini-2.5-flash"}),n=i.getGenerativeModel({model:"gemini-embedding-2"});async function s(e){return(await n.embedContent(e)).embedding.values}async function o(e){return JSON.parse((await a.generateContent({contents:[{role:"user",parts:[{text:e}]}],generationConfig:{responseMimeType:"application/json"}})).response.text())}},2223:(e,t,r)=>{"use strict";function i(e){return`
...
CV TEXT:
${e}
`}function a(e,t,r){let i=JSON.stringify({skills:e.skills,experience:e.experience.map(e=>({title:e.title,description:e.description})),projects:e.projects.map(e=>({name:e.name,technologies:e.technologies})),education:e.education},null,2),a=t.slice(0,15).map(e=>({title:e.title,skills:e.skills?.slice(0,10),requirements:e.requirements?.slice(0,5),role_category:e.role_category,matchScore:e.matchScore}));return`
...
`}function n(e,t){let r=JSON.stringify({skills:e.skills,experience:e.experience.map(e=>({title:e.title,description:e.description})),projects:e.projects.map(e=>({name:e.name,technologies:e.technologies})),education:e.education},null,2);return`
...
`}r.d(t,{bf:()=>a,cn:()=>n,sK:()=>i})}};var t=require("../../../webpack-runtime.js");t.C(e);var r=e=>t(t.s=e),i=t.X(0,[948,972,258,263],()=>r(871));module.exports=i})();